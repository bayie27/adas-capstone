...
> Read it in full before starting any package. Derived from `docs/archive/be_decisions_review.md` D-001…D-012.
>
...
> **2026-08-10 (docs/archive/be_audit/A3_ai_seam.md, F3):** `GET /api/internal/cameras` and
