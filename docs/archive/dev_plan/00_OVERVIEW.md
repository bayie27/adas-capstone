...
kickoff-prompt companion. It is a sibling of `docs/archive/be_plan/` and `docs/archive/be_audit/` and follows their
...
5. **Do not edit the repo-root working docs** (`docs/archive/be_decisions_review.md`, `final_paper_text.txt`,
