...
> **Prerequisite reading:** [`01_CONTRACTS.md`](01_CONTRACTS.md) §12, `docs/archive/be_decisions_review.md`
...
Write results to `docs/archive/be_plan/EVIDENCE.md` with the machine spec, date, and dataset size. **Label every
...
**File:** new `docs/archive/be_plan/TRACEABILITY.md`
...
**File:** new `docs/archive/be_plan/MANUAL_TESTS.md`
...
8. `docs/archive/be_plan/TRACEABILITY.md` has a row for every test case in the paper and **no blank Owner cell**.
