...
Read `CLAUDE.md`, `docs/archive/be_plan/01_CONTRACTS.md` §§5, 8, 9, 10, this package, and
`docs/archive/be_plan/14_EDGE_CASES.md` §§1, 7, 10. Search `Resolved|RESOLVED|resolve|ALERT_RESOLVE|total_resolved`
