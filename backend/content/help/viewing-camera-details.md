...
heartbeat — the engine is alive and reporting trouble) from one whose AI engine has
stopped responding entirely (a stale heartbeat, no error code — there's no one left to
report anything).
