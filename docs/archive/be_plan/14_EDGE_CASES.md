...
> `inapplicable`) and evidence in `docs/archive/be_audit/EDGE_CASE_COVERAGE.md`, built 2026-08-11 by the A5 audit
> pack and closed to 140/143 `covered` the same day. Check there before re-investigating a row — and
> see `docs/archive/be_audit/00_FINDINGS.md` F24–F31 for what those gaps turned out to be (F24–F30 fixed, F31 open
