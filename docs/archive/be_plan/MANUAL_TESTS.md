...
> everything in `docs/archive/be_plan/TRACEABILITY.md` marked `manual` — cases that
...
> `docs/archive/be_plan/EVIDENCE.md`'s machine spec — not the production-target 8×L4
...
### Results — 2026-08-11 (`docs/archive/be_audit/A6_manual_evidence.md`)

Executed on the demo laptop (see `docs/archive/be_plan/EVIDENCE.md` machine spec), operator: this audit
...
### Results — 2026-08-16 (`docs/archive/be_plan/18_PKG_scheduled_maintenance.md` Step 8)
...
### Results — 2026-08-16 (`docs/archive/be_plan/18_PKG_scheduled_maintenance.md` Step 8, drill 4 — regression)
...
Six of nine procedures executed 2026-08-11 as part of `docs/archive/be_audit/A6_manual_evidence.md`, all
...
not re-run quietly until a passing number appeared) — see `docs/archive/be_audit/00_FINDINGS.md`'s F22
resolution-log entry for the full account. `docs/archive/be_plan/TRACEABILITY.md` and `docs/archive/be_audit/00_FINDINGS.md`
