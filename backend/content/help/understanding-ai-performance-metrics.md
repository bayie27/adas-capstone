...
dismissals), precision shows as unavailable rather than 0% — 0% would incorrectly
...
shows higher average confidence on confirmed accidents than on dismissed ones — that
gap is a sign the model's certainty actually tracks with reality. If the two numbers
