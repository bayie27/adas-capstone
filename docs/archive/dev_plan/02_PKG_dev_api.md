...
> · `CLAUDE.md` (the audit-transaction and services-layer rules) · `docs/archive/be_plan/01_CONTRACTS.md` §§6–7
> **Size:** L. Six steps.
...
**This is behaviour-preserving refactoring of a recently audited seam** (`docs/archive/be_audit/A3_ai_seam.md`,
