...
> Dated local reference. The live validation documents and tracker listed in [CLAUDE.md](../../CLAUDE.md#live-google-drive-resources) govern current execution. Relocation does not revalidate these contents.
