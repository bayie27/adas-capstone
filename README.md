...
| `-Lan`               | Starts every component over **real TLS**, bound to all interfaces, so a second machine can reach the dashboard at `https://<host>:5173` — see [`LAN_SETUP.md`](LAN_SETUP.md). Bare `-Lan` means all four  |
