...
**24,000 lines across 152 backend files in two days**. `docs/archive/be_plan/` declared the backend finished and
production-ready. This directory is the pass that checks whether that is true.

`docs/archive/be_plan/` is the **planning record and stays immutable** except where a pack explicitly appends to
it. `docs/archive/be_audit/` is the verification record.
...
**A1**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, `docs/archive/be_audit/DEMO_TOPOLOGY.md`, then
> `docs/archive/be_audit/A1_lan_tls_drill.md`, and execute that pack. The target topology is two laptops on a
...
**A2**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, then `docs/archive/be_audit/A2_critical_fixes.md`, and
...
**A3**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, `docs/archive/be_plan/01_CONTRACTS.md` §6, then
> `docs/archive/be_audit/A3_ai_seam.md`, and execute that pack. The live seam drill at the end needs the real
> stack running; you have permission to start it.

**A4**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, then `docs/archive/be_audit/A4_realtime_hardening.md`,
...
**A5**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, `docs/archive/be_plan/14_EDGE_CASES.md`, then
> `docs/archive/be_audit/A5_edge_cases.md`, and execute that pack. Part 2 is the larger half — do not mark a row
> `covered` on the strength of a plausible test name; open the test.

**A6**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, `docs/archive/be_plan/MANUAL_TESTS.md`,
> `docs/archive/be_plan/EVIDENCE.md`, then `docs/archive/be_audit/A6_manual_evidence.md`, and execute that pack. This is
> mostly execution and recording, not coding. Record what you observe, including failures.

**A7**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, `final_paper_text.txt`,
> `docs/archive/be_plan/TRACEABILITY.md`, then `docs/archive/be_audit/A7_paper_reconciliation.md`, and execute that pack.
> Documentation only — no code changes.

**A8**
> Read `docs/archive/be_audit/README.md`, `docs/archive/be_audit/00_FINDINGS.md`, then `docs/archive/be_audit/A8_housekeeping.md`, and
