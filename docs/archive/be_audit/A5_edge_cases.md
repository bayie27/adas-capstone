...
> **Read before starting:** `docs/archive/be_plan/14_EDGE_CASES.md` (all ten categories),
> `docs/archive/be_plan/TRACEABILITY.md`, `docs/archive/be_audit/00_FINDINGS.md`.
...
**Deliverable: `docs/archive/be_audit/EDGE_CASE_COVERAGE.md`** — every row of all ten categories of
...
- 1.12 cross-operation tests pass; 1.7 and 1.14 have defined, tested behaviour with the outcome
  written down.
- `docs/archive/be_audit/EDGE_CASE_COVERAGE.md` exists, covers every row, and has no blank Status cell.
