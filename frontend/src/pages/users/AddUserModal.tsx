          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-stroke bg-surface-1 px-3 py-2 text-sm text-white placeholder-fg-muted focus:border-stroke-strong focus:outline-none"
              />
            </div>
            <div>
