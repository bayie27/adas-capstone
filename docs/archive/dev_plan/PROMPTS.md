...
```
Execute docs/archive/dev_plan/01_PKG_seed_core.md in this repo.

Read these in full before writing any code, in this order:
  1. docs/archive/dev_plan/00_OVERVIEW.md
  2. docs/archive/dev_plan/01_PKG_seed_core.md
  3. CLAUDE.md
...
docs/archive/dev_plan/00_OVERVIEW.md is updated, and you have reported the three items under
"Report back".
```
...
```
Execute docs/archive/dev_plan/02_PKG_dev_api.md in this repo.

Read these in full before writing any code, in this order:
  1. docs/archive/dev_plan/00_OVERVIEW.md
  2. docs/archive/dev_plan/02_PKG_dev_api.md
  3. docs/archive/dev_plan/01_PKG_seed_core.md  (what Package A built, which you import)
...
recently audited seam (docs/archive/be_audit/A3_ai_seam.md, the F20 fix in commit e7c80ef). It
...
```
Execute docs/archive/dev_plan/03_PKG_dev_panel.md in this repo.

Read these in full before writing any code, in this order:
  1. docs/archive/dev_plan/00_OVERVIEW.md
  2. docs/archive/dev_plan/03_PKG_dev_panel.md
  3. docs/archive/dev_plan/02_PKG_dev_api.md, section 5  (the endpoint shapes you code against)
...
docs/archive/dev_plan/00_OVERVIEW.md is updated, and you have reported the two items under
"Report back".
```
...
```
Execute docs/archive/dev_plan/04_PKG_launcher.md in this repo.

Read these in full before writing any code, in this order:
  1. docs/archive/dev_plan/00_OVERVIEW.md
  2. docs/archive/dev_plan/04_PKG_launcher.md
  3. scripts/start-sim.ps1  (the shape to follow)
  4. README.md, the "Running the System" section
  5. docs/archive/be_audit/DEMO_TOPOLOGY.md, section 5  (the real demo-day bring-up order)
  6. CLAUDE.md
...
updated, the status table in docs/archive/dev_plan/00_OVERVIEW.md is updated, and you have
