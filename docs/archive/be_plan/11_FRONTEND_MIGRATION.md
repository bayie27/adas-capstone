...
The backend is being rebuilt against `docs/archive/be_decisions_review.md` (D-001…D-012). Most changes are
...
contract — say so rather than adapting around it. `docs/archive/be_plan/01_CONTRACTS.md` is the authority, and it
