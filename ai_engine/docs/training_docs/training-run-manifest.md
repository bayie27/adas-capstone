...
- Project state and run caveats (source research repository: `../CLAUDE.md`; not included here)
- Chronological detection results (source research repository: `../docs/results.md`; not included here)
- Training notebook source (source research repository: `../train/adas_train_colab.ipynb`; not included here)
- Shared quota and incident helpers (source research repository: `../dataset/pipeline.py`; not included here)
