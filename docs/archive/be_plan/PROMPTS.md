...
```
Execute docs/archive/be_plan/02_PKG_foundation.md in this repo.

Read these in full before writing any code, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (long — read all of it, it is the frozen spec)
  2. docs/archive/be_plan/02_PKG_foundation.md
  3. docs/archive/be_plan/14_EDGE_CASES.md
  4. docs/archive/be_decisions_review.md, decision D-005
...
- Do NOT edit the repo-root working docs (docs/archive/be_decisions_review.md, final_paper_text.txt,
...
docs/archive/be_plan/14_EDGE_CASES.md tagged P1 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report anything you
...
```
Execute docs/archive/be_plan/03_PKG_auth_audit.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md
  2. docs/archive/be_plan/03_PKG_auth_audit.md
  3. docs/archive/be_plan/14_EDGE_CASES.md  (sections 8 and 1 especially)
  4. docs/archive/be_decisions_review.md, decisions D-006 and D-007
...
- Do NOT modify ai_engine/ or frontend/. This package intentionally breaks the
  frontend; the migration guide is docs/archive/be_plan/11_FRONTEND_MIGRATION.md and is a
...
When done: run the doc's Verification section, then walk every row in
docs/archive/be_plan/14_EDGE_CASES.md tagged P2 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report deviations
...
```
Execute docs/archive/be_plan/04_PKG_realtime.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§9 especially)
  2. docs/archive/be_plan/04_PKG_realtime.md
  3. docs/archive/be_plan/14_EDGE_CASES.md
  4. docs/archive/be_decisions_review.md, decision D-008
...
When done: run the doc's Verification section, then walk every row in
docs/archive/be_plan/14_EDGE_CASES.md tagged P3 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report deviations
...
```
Execute docs/archive/be_plan/05_PKG_incidents_cameras.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§§5.3, 6, 7, 10, 11 especially)
  2. docs/archive/be_plan/05_PKG_incidents_cameras.md
  3. docs/archive/be_plan/14_EDGE_CASES.md  (sections 1, 5, 7, 9, 10 especially)
  4. docs/archive/be_decisions_review.md, decisions D-002, D-003, D-004, D-012
...
- Do NOT modify ai_engine/. The v2 contract is written down in
  docs/archive/be_plan/12_AI_ENGINE_CONTRACT.md for its owner. The LEGACY contract
...
docs/archive/be_plan/14_EDGE_CASES.md tagged P4 — there are many — and add tests for any not
already covered, then `pnpm check`, then update the status table in
docs/archive/be_plan/00_INDEX.md. Report deviations and any edge-case row you skipped.
```
...
```
Execute docs/archive/be_plan/06_PKG_system_health.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§3.7 especially)
  2. docs/archive/be_plan/06_PKG_system_health.md
  3. docs/archive/be_plan/14_EDGE_CASES.md  (sections 3 and 6 especially)
  4. docs/archive/be_decisions_review.md, decision D-009
...
When done: run the doc's Verification section, then walk every row in
docs/archive/be_plan/14_EDGE_CASES.md tagged P5 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report deviations
and any edge-case row you skipped.
```
...
```
Execute docs/archive/be_plan/07_PKG_reports.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§§1.4, 1.5, 3.8, 5.10 especially)
  2. docs/archive/be_plan/07_PKG_reports.md
  3. docs/archive/be_plan/14_EDGE_CASES.md  (sections 3 and 4 especially)
  4. docs/archive/be_decisions_review.md, decision D-010
...
docs/archive/be_plan/14_EDGE_CASES.md tagged P6 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report deviations
and any edge-case row you skipped.
```
...
```
Execute docs/archive/be_plan/08_PKG_backup_ops.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§3.10 especially)
  2. docs/archive/be_plan/08_PKG_backup_ops.md
  3. docs/archive/be_plan/14_EDGE_CASES.md  (sections 1 and 6 especially)
  4. docs/archive/be_decisions_review.md, decision D-011
...
the rollback drill, both timed — then walk every row in docs/archive/be_plan/14_EDGE_CASES.md
tagged P7 and add tests for any not already covered, then `pnpm check`, then update
the status table in docs/archive/be_plan/00_INDEX.md. Record the measured timings; they are paper
...
```
Execute docs/archive/be_plan/09_PKG_help_center.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§§3.9, 5.11 especially)
  2. docs/archive/be_plan/09_PKG_help_center.md
  3. docs/archive/be_plan/14_EDGE_CASES.md
...
When done: run the doc's Verification section, then walk every row in
docs/archive/be_plan/14_EDGE_CASES.md tagged P8 and add tests for any not already covered, then
`pnpm check`, then update the status table in docs/archive/be_plan/00_INDEX.md. Report deviations
and any edge-case row you skipped.
```
...
```
Execute docs/archive/be_plan/10_PKG_migration_evidence.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§12 especially)
  2. docs/archive/be_plan/10_PKG_migration_evidence.md
  3. docs/archive/be_plan/14_EDGE_CASES.md
  4. docs/archive/be_decisions_review.md, decisions D-001 (the boundary rule) and D-005
...
`git log --oneline` and the status table in docs/archive/be_plan/00_INDEX.md before starting.
...
Also do a final sweep of docs/archive/be_plan/14_EDGE_CASES.md across ALL packages and report which
...
```
Execute docs/archive/be_plan/15_PKG_ai_engine_integration.md in this repo.

Read in full first, in this order:
  1. docs/archive/be_plan/01_CONTRACTS.md  (§§6 and 7 especially — the v2 contract)
  2. docs/archive/be_plan/15_PKG_ai_engine_integration.md
  3. docs/archive/be_plan/12_AI_ENGINE_CONTRACT.md  (background: the full D-012 picture)
  4. docs/archive/be_plan/14_EDGE_CASES.md
  5. docs/archive/be_decisions_review.md, decisions D-003 and D-012
...
When done: run the doc's Verification section, then walk docs/archive/be_plan/14_EDGE_CASES.md
...
```text
Execute docs/archive/be_plan/28_PKG_cleared_incident.md completely on branch
feat/be-p28-cleared-incident from the shared P28-P30 planning commit.

Use gpt-5.6-luna at max reasoning. Read CLAUDE.md, docs/archive/be_plan/01_CONTRACTS.md,
the complete P28 document, docs/archive/be_plan/14_EDGE_CASES.md, and the authoritative
...
```text
Execute docs/archive/be_plan/29_PKG_admin_ai_performance.md on branch
feat/be-p29-admin-ai-performance using gpt-5.6-luna at max reasoning.

Read CLAUDE.md, docs/archive/be_plan/01_CONTRACTS.md, the complete P29 document,
docs/archive/be_plan/14_EDGE_CASES.md, and paper_sync instructions before editing. You may
...
```text
Execute docs/archive/be_plan/30_PKG_protected_backup_storage.md on branch
...
P30 document, docs/archive/be_plan/14_EDGE_CASES.md, and paper_sync instructions first. Build
...
```
Execute docs/archive/be_plan/11_FRONTEND_MIGRATION.md in this repo.

Read docs/archive/be_plan/11_FRONTEND_MIGRATION.md in full first. Read docs/archive/be_plan/01_CONTRACTS.md
...
```
Execute docs/archive/be_plan/13_WSL2_LINUX_PATH.md in this repo.

Read docs/archive/be_plan/13_WSL2_LINUX_PATH.md in full first, then docs/archive/be_plan/08_PKG_backup_ops.md
...
docs/archive/be_plan/EVIDENCE.md labeled "WSL2 Ubuntu 24.04, not production hardware", alongside
...
docs/archive/be_plan/01_CONTRACTS.md and this package doc. Give it the branch name and the doc
