...
> **Prerequisite reading:** [`01_CONTRACTS.md`](01_CONTRACTS.md) §§6, 7 · `12_AI_ENGINE_CONTRACT.md` (`12_AI_ENGINE_CONTRACT.md`; historical reference unavailable in this checkout)
> · `docs/archive/be_decisions_review.md` D-003 and D-012.
> **Size:** L. Eight steps.
>
