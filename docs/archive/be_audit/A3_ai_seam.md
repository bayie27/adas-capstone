...
> **Read before starting:** `docs/archive/be_plan/01_CONTRACTS.md` §6, `docs/archive/be_plan/15_PKG_ai_engine_integration.md`,
> `docs/archive/be_plan/16_HEARTBEAT_VS_POLLING.md`, `docs/archive/be_audit/00_FINDINGS.md`.
...
- `docs/archive/be_plan/01_CONTRACTS.md` §6.1 — mark the two routes removed, with the date and this pack as the
...
Record the results in `docs/archive/be_audit/00_FINDINGS.md`. Anything that does not behave as described is a
